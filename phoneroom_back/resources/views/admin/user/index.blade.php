            ...
            <table class="table table-hover table-striped table-ligth">
                ...
                @foreach($users as $u)
                    <tr>
                        ...
                        <th scope="col">{{ $u->position->name }}</th>
                        <th scope="col">{{ $u->email }}</th>
                        <th scope="col">{{ $u->phone }}</th>
                        <th scope="col">{{ $u->profile->address->city ?? 'Не задан'  }}</th>
                        <th scope="col">{{ $u->profile->address->street ?? 'Не задана'  }}</th>
                        <th scope="col">{{ $u->profile->address->house ?? 'Не задан'  }}</th>
