...
<div class="h-100" id="app">
    <nav class="navbar navbar-expand-md shadow-sm">
        <div class="container">
            <div class="logo">
                <img src="<?php echo e(asset('dist/img/Group 776.svg')); ?>" alt="">
                <a class="brand-title" href="<?php echo e(env('APP_URL', '/')); ?>">
...
<?php /**PATH D:\projects\phoneroom_back\resources\views/layouts/app.blade.php ENDPATH**/ ?>